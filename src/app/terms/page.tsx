        ...
        <>
            ...
            <div style={{ maxWidth: '760px', margin: '0 auto', padding: '60px 24px' }}>
                ...
                {[
                    ...
                    { title: '3. No Refund Policy', body: 'All sales are final. Harry\'s Picks maintains a strict no-refund policy. Please review all package details carefully before making a purchase. By completing a purchase, you agree to these terms.' },
                    ...
                    { title: '6. SMS Communications', body: 'By texting PICK to 51501, you consent to receive automated text messages from Harry\'s Picks. Message & data rates may apply. Reply STOP at any time to unsubscribe.' },
                    { title: '7. Disclaimer', body: 'Sports betting involves risk. Past performance of picks does not guarantee future results. Harry\'s Picks makes no warranty that any picks will result in financial gain. Bet responsibly.' },
                ].map(section => (
