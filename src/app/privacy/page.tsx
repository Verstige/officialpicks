        ...
        <>
            ...
            <div style={{ maxWidth: '760px', margin: '0 auto', padding: '60px 24px' }}>
                ...
                {[
                    ...
                    { title: '3. SMS and Email Communications', body: 'By providing your phone number or email, you consent to receiving picks, alerts, and important account notifications from Official Picks. You can opt out at any time by replying STOP to any SMS or clicking unsubscribe in any email.' },
                    ...
                    { title: '6. No Sale of Data', body: 'We will never sell, lease, or trade your personal information to third parties. Your data stays with Official Picks, period.' },,
